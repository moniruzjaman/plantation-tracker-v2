        ...
        <Card className="bg-emerald-50/50 border-emerald-200">
          <CardContent className="p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Synced to Server</p>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input id="siteName" name="siteName" placeholder="e.g. Dhaka North Block A" value={formData.siteName} onChange={handleChange} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="species">Species</Label>
                <Input id="species" name="species" placeholder="e.g. Akashmoni (Acacia auriculiformis)" value={formData.species} onChange={handleChange} />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              <div className="space-y-2">
                <Label htmlFor="dbh" className="flex items-center gap-1">
                  <Ruler className="w-3.5 h-3.5" /> DBH (cm)
                </Label>
              ...
              <div className="space-y-2">
                <Label htmlFor="height" className="flex items-center gap-1">
                  <TreePine className="w-3.5 h-3.5" /> Height (m)
                </Label>
              ...
              <div className="space-y-2">
                <Label htmlFor="gpsLat" className="flex items-center gap-1">
                  <Navigation className="w-3.5 h-3.5" /> Latitude
                </Label>
                <div className="flex gap-1">
                  <Input id="gpsLat" name="gpsLat" placeholder="23.8103" value={formData.gpsLat} onChange={handleChange} />
                  <Button variant="outline" size="icon" className="shrink-0" onClick={handleGPS} title="Get GPS">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input placeholder="e.g. 32°C" />
              </div>
              <div className="space-y-2">
                <Label className="flex items-center gap-1">
                  <CloudRain className="w-3.5 h-3.5" /> Rainfall
                </Label>
                <Input placeholder="e.g. 180mm/month" />
              </div>
            </div>

            <div className="space-y-2">
              <Label htmlFor="notes">Field Notes</Label>
              <Textarea id="notes" name="notes" placeholder="Observations, conditions, any anomalies..." rows={3} value={formData.notes} onChange={handleChange} />
            </div>

            <div className="flex items-center gap-3">
              <Button onClick={handleSubmit} className="gap-2">
                <Save className="w-4 h-4" />
                {submitted ? 'Saved!' : 'Save Measurement'}
              </Button>

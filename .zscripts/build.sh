...
if [ ! -f ".next/standalone/server.js" ]; me
...
if [ -d ".next/standalone" ]; then
    ...
    cp -r .next/standalone/* "$BUILD_DIR/next-service-dist/" 2>/dev/null || cp -r .next/standalone "$BUILD_DIR/next-service-dist/"
fi
...
# টেম্পোরারি ডিরেক্টরি মুছে ফেলার জন্য নিচের লাইনটি আনকমেন্ট করতে পারেন:
# rm -rf "$BUILD_DIR"
